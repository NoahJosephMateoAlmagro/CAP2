...
void rayTracingCPUMain(unsigned char *img, int w, int h, int ns = 10, int px = 0, int py = 0, int pw = -1, int ph = -1)
{
	if (pw == -1)
		pw = w;
	if (ph == -1)
...
void rayTracingCPU_MPIMP_Bloques(unsigned char *img, int w, int h, int ns = 10, int px = 0, int py = 0, int pw = -1, int ph = -1)
{
	if (pw == -1)
		pw = w;
	if (ph == -1)
...
void rayTracingCPU_MPIMP_Columnas(unsigned char *img, int w, int h, int ns = 10, int px = 0, int py = 0, int pw = -1, int ph = -1)
{
	if (pw == -1)
		pw = w;
	if (ph == -1)
...
void rayTracingCPU_MPIMP_Filas(unsigned char *img, int w, int h, int ns = 10, int px = 0, int py = 0, int pw = -1, int ph = -1)
{
	if (pw == -1)
		pw = w;
	if (ph == -1)
...
int main(int argc, char *argv[])
{
	...
	*/
	...
	// En Serie
	rayTracingCPUMain(data, w, h, ns, patch_x_start, patch_y_start, patch_x_end, patch_y_end);
	...
	printf("Tiempo de ejecución con repartición en serie: %f segundos\n", elapsed.count());

	writeBMP("imgCPU_Serie.bmp", data, patch_x_size, patch_y_size);
	...
	// MPI Columnas
	rayTracingCPU_MPIMP_Columnas(data, w, h, ns, patch_x_start, patch_y_start, patch_x_end, patch_y_end);
	...
	if(rank == 0){
	// Mostrar tiempo transcurrido
	printf("Tiempo de ejecución con repartición en columnas con MPI y OMP: %f segundos\n", elapsed.count());

	
	writeBMP("imgCPU_MPIMP_Columnas.bmp", data, patch_x_size, patch_y_size);
	printf("Imagen creada.\n");
	}
	...
	// MPI Columnas
	rayTracingCPU_MPIMP_Filas(data, w, h, ns, patch_x_start, patch_y_start, patch_x_end, patch_y_end);
	...
	if(rank == 0){
	// Mostrar tiempo transcurrido
	printf("Tiempo de ejecución con repartición en filas con MPI y OMP: %f segundos\n", elapsed.count());


	writeBMP("imgCPU_MPIMP_Filas.bmp", data, patch_x_size, patch_y_size);
	printf("Imagen creada.\n");
	}	
	...
	// MPI Columnas
	rayTracingCPU_MPIMP_Bloques(data, w, h, ns, patch_x_start, patch_y_start, patch_x_end, patch_y_end);
	...
	// Mostrar tiempo transcurrido
	printf("Tiempo de ejecución con repartición en bloques con MPI y OMP: %f segundos\n", elapsed.count());

	writeBMP("imgCPU_MPIMP_Bloques.bmp", data, patch_x_size, patch_y_size);
	printf("Imagen creada.\n");
