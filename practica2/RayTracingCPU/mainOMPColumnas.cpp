...
void rayTracingCPU_OMP_Col(unsigned char *img, int w, int h, int ns = 10, int px = 0, int py = 0, int pw = -1, int ph = -1)
{   
...
int main(int argc, char *argv[])
{
    ...
    rayTracingCPU_OMP_Col(data, w, h, ns);

    double end_time = omp_get_wtime();

    writeBMP("imgOMPColumnas.bmp", data, w, h);
